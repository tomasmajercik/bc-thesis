"""
Modulated base model for ablation study without zoom encoder.
"""
import torch
...
class MultiEncoderUNet(nn.Module):
    ...
    def forward(self, past, imp, ctx, past_coords=None, return_attention=False):
