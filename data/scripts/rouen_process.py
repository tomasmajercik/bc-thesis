...
if __name__ == "__main__":
    ...
    for frame_id in tqdm(frame_ids, desc="Processing frames"):
        ...
        for pid in future_heatmaps.keys():
            save_file = Path(f"../processed/rouen/input/{iterator:04d}.npy")
            gt_dir    = Path("../processed/rouen/target"); gt_dir.mkdir(parents=True, exist_ok=True)
            ...
            coords_dir = Path("../processed/rouen/target_coords")
    ...
    obstacle_mask_file = Path("../processed/rouen/obstacle_mask.npy")
